...
import 'telas/telas_planetas.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Planetas',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 7, 25, 106)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Aplicativo dos Planeta'),
    );
  }
}
